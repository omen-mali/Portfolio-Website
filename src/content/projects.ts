...
export const projects: Project[] = [
  ...
  {
    slug: "arduino-temperature-humidity-sensor",
    title: "Room Temperature & Humidity Sensor",
    description:
      "Embedded room temperature and humidity sensor on the Arduino UNO, using analog & digital sensors and LCD display. Work in progress: Implement IoT capabilities with ESP8266.",
